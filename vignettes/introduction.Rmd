...
You can even customize these shiny input values by including a `shiny` option in the `options` parameter. Please see the Vignette `shiny_options` for more details.
