...
```{r, echo=FALSE}
knitr::kable(data.frame(Interaction_type = c('draggagle', 'droppable', 'resizable', 'selectable', 'sortable'),
                        suffix = c('position', 'dragging', 'size', 'selected', 'order'),
                        `The_returned_shiny_input_value` = c('A list of the element\'s left and top distances (in pixels) to its parent element',
...
Following are some examples for each iteractions.
